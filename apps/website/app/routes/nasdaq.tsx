import type { Route } from "./+types/nasdaq";
...
export default function Nasdaq(_args: Route.ComponentProps) {
  const { funds, fetchedAt } = useLoaderData<typeof loader>();
  return (
    <div className="min-h-screen bg-background">
      <AppHeader currentLabel="纳指被动" />
      <main className="container mx-auto max-w-6xl px-3 py-6 sm:px-4">
        {/* 整页内容（标题 + 筛选 + 列表）都依赖 funds，统一用 AsyncSection 包装 */}

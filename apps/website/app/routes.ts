...
export default [
  ...
  route("global/stable", "routes/legacy.stable.tsx"),
  route("qdii", "routes/legacy.qdii.tsx"),
  route("qdii-valuation", "routes/legacy.qdii-valuation.tsx"),
  route("nasdaq", "routes/legacy.nasdaq.tsx"),
  route("sp500", "routes/legacy.sp500.tsx"),
  route("active", "routes/legacy.active.tsx"),
  // SEO 资源路由
